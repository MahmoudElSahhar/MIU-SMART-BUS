...
public class WatchBusStopsOnMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_watch_bus_stops_on_map);
        ...
        if(StudentWelcomeActivity.destination.getSelectedItemPosition() == 1)
        {
            myRef = database.getReference().child("Bus Lines").child(StudentToUniActivity.whichBus.getSelectedItem().toString());
        }
        else if(StudentWelcomeActivity.destination.getSelectedItemPosition() == 2)
        {
            myRef = database.getReference().child("Bus Lines").child(StudentToHomeActivity.spinner.getSelectedItem().toString());
        }
        ...
        navigate = (Button)findViewById(R.id.watchStopsNavigate);
        navigate.setVisibility(View.INVISIBLE);
        stopNavigation = (Button)findViewById(R.id.stopNavigationWatchStops);
        stopNavigation.setVisibility(View.INVISIBLE);
        distanceBar = (TextView)findViewById(R.id.watchStopsDistance);
        durationBar = (TextView)findViewById(R.id.watchStopsDuration);
    ...
    public void calculateDistance(String text, Marker myMarker)
    {
        ...
        ////////////////////////////////////////////
        myCurrentLocation.setLatitude(userLocation.latitude);
        myCurrentLocation.setLongitude(userLocation.longitude);
        ...
        infoBar.setText(text /*+ "\n Distance to " + objectName + " stop: " + DF.format(results[0]/1000) + " KM"*/);
    }
